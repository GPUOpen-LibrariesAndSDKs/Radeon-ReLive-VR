...
- Download the latest ReLive VR APK file from this repo.
...
- Copy the ReLive VR APK file to your phone using any method (USB, download via Google Drive, Dropbox, etc)
